    ...
    <div ref={contextRef}>
            <div style={{ clipPath: 'polygon(0 0, 100% 0, 100% 100%, 0 100%)' }}>
                ...
                pt-16 sm:gap-16'>
                    ...
                    <div className='px-10'>
                        ...
                        uppercase banner-text-responsive sm:gap-16 
                        md:block -translate-y-2 ${textColor}`}>
                            {title}
                        </h1>
                    </div>
                </div>
            ...
            <div className={`relative px-10 ${textColor}`}>
                ...
                <div className='py-12 sm:py-16 text-end'>
                    <AnimatedTextLines text={text} className={`font-light uppercase
                    value-text-responsive ${textColor}`} />
                </div>
            </div>
    </div>
  )
