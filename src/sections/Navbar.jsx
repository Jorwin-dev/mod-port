...
const [showBurger, setShowBurger] = useState(true);
  ...
  return ( 
    ...
    w-full h-full px-10 uppercase bg-black text-white/80 
    ...
    >
        ...
        >
            <span ref={topLineRef} className='block w-8 h-0.5 bg-white rounded-full
            origin-center'></span>
            <span ref={bottomLineRef} className='block w-8 h-0.5 bg-white rounded-full
            origin-center'></span>
        </div>
    </>
  );
